...
namespace Game.GameCore {
    ...
    public partial class DOT : IUpdatableFrom<Game.GameCore.DOT>, IUpdatableFrom<Game.GameCore.RTSRuntimeData>, IBinaryDeserializable, IBinarySerializable, IHashable, ICompareCheckable<Game.GameCore.RTSRuntimeData>, IJsonSerializable, IPolymorphable, ICloneInst
    {
        ...
        public override void CompareCheck(Game.GameCore.RTSRuntimeData other, ZRCompareCheckHelper __helper, Action<string> printer) 
        {
            ...
            var otherConcrete = (Game.GameCore.DOT)other;
            if (dps != otherConcrete.dps) CodeGenImplTools.LogCompError(__helper, "dps", printer, otherConcrete.dps, dps);
        }
