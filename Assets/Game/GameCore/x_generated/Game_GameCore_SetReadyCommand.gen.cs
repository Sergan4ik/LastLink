...
namespace Game.GameCore {
    ...
    public partial class SetReadyCommand : IUpdatableFrom<Game.GameCore.SetReadyCommand>, IUpdatableFrom<ZeroLag.ZeroLagCommand>, IBinaryDeserializable, IBinarySerializable, IHashable, ICompareCheckable<ZeroLag.ZeroLagCommand>, IJsonSerializable, IPolymorphable, ICloneInst
    {
        public override void UpdateFrom(ZeroLag.ZeroLagCommand other, ZRUpdateFromHelper __helper) 
        {
            base.UpdateFrom(other,__helper);
            var otherConcrete = (Game.GameCore.SetReadyCommand)other;
            factionSlot = otherConcrete.factionSlot;
            factionType = otherConcrete.factionType;
            globalPlayerId = otherConcrete.globalPlayerId;
        }
        public void UpdateFrom(Game.GameCore.SetReadyCommand other, ZRUpdateFromHelper __helper) 
        {
        ...
        {
        return (System.UInt16)Types.SetReadyCommand;
        }
        public override System.Object NewInst() 
        {
        return new SetReadyCommand();
        }
    }
}
#endif
